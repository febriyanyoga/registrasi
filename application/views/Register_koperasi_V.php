...
<head>
    ...
    <title>Lengkapi Data Koperasi - Arnawa</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box" style="max-width: 650px;">
                <div>
                    <div class="logo">
                        ...
                        <h2 class="font-medium m-b-20" style="color: #4798e8;">Lengkapi Data Koperasi Anda</h2>
                    </div>
                    <!-- Form -->
                    <div class="row">
                         <?php
                        ...
                        <form class="form p-t-20" action="<?php echo base_url('KoperasiC/input_data_koperasi')?>" method="post" onSubmit="return validate()">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control form-control-lg" placeholder="Nama Koperasi" name="nama_koperasi" id="nama_koperasi" required>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <input type="number" class="form-control form-control-lg" onkeypress="return hanyaAngka(event)" placeholder="No. Telepon Koperasi" name="tlp_koperasi" id="tlp_koperasi" >
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="ti-mobile"></i></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <textarea name="alamat_koperasi" style="height: 100px;" class="form-control form-control-lg" placeholder="Alamat Koperasi" required></textarea>
                                            <div class="input-group-append">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <input type="email" class="form-control form-control-lg" placeholder="Email Koperasi" name="email_koperasi" id="email_koperasi">
                                            <div class="input-group-append">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control form-control-lg" placeholder="Website Koperasi" name="web_koperasi" id="web_koperasi" >
                                            <div class="input-group-append">
